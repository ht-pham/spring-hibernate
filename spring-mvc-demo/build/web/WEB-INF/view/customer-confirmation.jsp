...
<html>
    ...
    <body>
        ...
        <p style="font-size:smaller;"> The store has a new ${newCustomer.age}-years-old customer from ${newCustomer.postalCode} 
            join the store's membership program. Today's date: <%
            Date date = new Date();
